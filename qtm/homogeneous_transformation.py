...
class HomogenousTransformation:
    ...
    @staticmethod
    def mass_transform(molecules, coordinates, transform_params, rotation_origin_dict):
        """
            ...
            new_coords.extend(
                HomogenousTransformation._transform_a_molecule(
                    ...
                    *transform_params[i * 6: (i + 1) * 6],
                    rotation_origin_dict.get(i, (0, 0, 0))
                )
            )
    ...
    @staticmethod
    def _transform_a_molecule(coordinates, theta_x, theta_y, theta_z, t_x, t_y, t_z, rotation_origin=(0, 0, 0)):
        ...
        trans_matrix = HomogenousTransformation._generate_transform_matrix(
            theta_x, theta_y, theta_z, t_x, t_y, t_z, rotation_origin
        )
